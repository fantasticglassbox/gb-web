        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 w-full">
          ...
          >
            ...
            <div className="mb-10 md:mb-16 w-full">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 mb-6 tracking-tight leading-[1.02] break-words">
                {t('privacy.title')}{' '}
                <span className="text-glassbox-blue">{t('privacy.subtitle')}</span>
              </h1>
            ...
            <div className="prose prose-slate md:prose-lg max-w-none prose-headings:font-bold prose-headings:text-gray-900 prose-p:text-gray-600 prose-p:leading-relaxed prose-li:text-gray-600 prose-headings:leading-tight w-full">
