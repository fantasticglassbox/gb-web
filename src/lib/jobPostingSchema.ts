import type { CareerContent, Vacancy } from '../content/careers';
...
const DEFAULT_SALARY = { min: 6_000_000, max: 15_000_000, currency: 'IDR' as const };
...
export function buildGlassboxJobPostingSchema(params: {
  vacancy: Vacancy;
