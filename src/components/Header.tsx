...
const Header: React.FC = () => {
  ...
  const contactCtaOnHero = pathname === '/' && !scrolled;
            ...
            >
              <img
                ...
                className={`h-9 w-auto transition-all duration-300 ${
                  pathname === '/' && !scrolled ? 'brightness-0 invert' : 'brightness-100'
                }`}
              />
            </motion.div>
          </Link>
                ...
                {item.submenu ? (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="absolute bottom-0 left-4 right-4 h-0.5 bg-gradient-to-r from-glassbox-blue to-glassbox-purple transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
                    </motion.button>
                    <AnimatePresence>
                      {activeDropdown === item.name && (
                        ...
                        >
                          {item.submenu.map((subItem: any) => (
                            ...
                            >
                              {subItem.name}
                              <span className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-glassbox-blue to-glassbox-purple transform scale-y-0 group-hover:scale-y-100 transition-transform duration-300" />
                            </Link>
                          ))}
                        </motion.div>
                      )}
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <motion.button
              ...
              className={`lg:hidden p-2.5 rounded-full transition-all duration-300 ${
                scrolled || pathname !== '/' ? 'text-gray-900 bg-gray-100' : 'text-white bg-white/10'
