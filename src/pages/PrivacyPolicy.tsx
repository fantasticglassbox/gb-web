        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 w-full">
          ...
          >
            ...
            <div className="mb-10 md:mb-16 w-full">
              ...
              <p className="text-gray-500 font-black uppercase tracking-widest text-[9px] md:text-xs w-full">{t('privacy.lastUpdated')}: {lastUpdated}</p>
            </div>

            <div className="prose prose-slate md:prose-lg max-w-none prose-headings:font-display prose-headings:font-bold prose-headings:text-gray-900 prose-p:text-gray-600 prose-p:leading-relaxed prose-li:text-gray-600 prose-headings:leading-tight prose-section:mb-10 md:prose-section:mb-12 w-full">
